        ...
        <div className="absolute bottom-8 left-0 right-0 flex justify-center gap-4">
          {!imageBase64 ? <>
            ...
            scale: 0.95
                ...
                <Button onClick={selectFromGallery} disabled={isCapturing} size="lg" variant="outline" className="h-16 w-16 rounded-full bg-[#ffffff] dark:bg-[#27272a] border-2 border-purple-500 shadow-lg hover:bg-[#ffffff] dark:hover:bg-[#3f3f46]">
            ...
            scale: 0.95
                ...
                <Button onClick={takePhoto} disabled={isCapturing} size="lg" className="h-24 w-24 rounded-full bg-[#ffffff] dark:bg-[#27272a] shadow-xl disabled:opacity-50 border-2 border-purple-500 hover:bg-[#ffffff] dark:hover:bg-[#3f3f46]">
