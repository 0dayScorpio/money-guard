...
export const TabBar = ({ activeTab, onTabChange, isDark, onThemeToggle }: TabBarProps) => {
  ...
  return (
    <div className="backdrop-blur-xl bg-card/70 border-t border-white/10 pb-[max(env(safe-area-inset-bottom,2px),2px)] py-[4px]">
      <div className="flex items-center justify-between px-3 pt-1 pb-1">
        ...
        <nav className="relative flex flex-1 py-1">
          ...
          <motion.div
            className="absolute top-1/2 h-[34px] rounded-full backdrop-blur-md bg-primary/12 border border-white/15 shadow-md pointer-events-none"
            style={{
